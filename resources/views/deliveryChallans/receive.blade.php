                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <hr class="mt-0">
                            <form action="{{ route('deliveryChallans.receive.store', $deliveryChallan->id) }}" method="POST">
                                @csrf
                                <div class="card-body general-info">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="invoice" class="form-label">Invoice #</label>
                                            <input type="text" class="form-control" id="invoice" value="{{ $deliveryChallan->po_no }}" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="client_name" class="form-label">Client Name</label>
                                            <input type="text" class="form-control" id="client_name" value="{{ $deliveryChallan->customer->first_name }}" readonly>
                                        </div>
                                    </div>
